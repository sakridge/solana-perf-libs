...
is_packed_ge_small_order(const unsigned char* packed_group_element) {
    ge_p3 signature_R;
...
int ed25519_is_packed_ge_small_order(const unsigned char* packed_group_element) {
    return is_packed_ge_small_order(packed_group_element);
}
