...
int main(int argc, const char* argv[]) {
    ...
    */
    /*
    uint8_t sig[64] = {232, 214, 141, 101, 106, 192, 17, 106, 90, 194, 26, 210, 201, 148, 187, 133, 190, 108, 221, 189, 118, 112, 233, 0, 224, 106, 168, 201, 240, 234, 206, 106, 204, 100, 175, 28, 207, 96, 93, 163, 124, 158, 65, 148, 233, 99, 162, 207, 40, 176, 97, 226, 0, 100, 130, 88, 199, 73,134, 233, 197, 71, 192, 11};
    uint8_t message[10] = {};
    uint8_t pubkey[32] = {};
